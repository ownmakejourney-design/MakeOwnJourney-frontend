...
const SignupForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center gap-8 bg-no-repeat bg-cover text-black ">
      <div className="w-[400px]  rounded-md  shadow-md py-5 px-5 shadow-gray-950 flex flex-col ">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          {/* Username */}
          <div>
            <label className="text-sm text-slate-800 hover:text-slate-950">
              Username
            </label>
            <input
              type="text"
